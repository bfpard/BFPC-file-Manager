...
<input
  id="email"
  type="email"
  class="mt-1 block w-full rounded-md border border-slate-300 px-3 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"
/>
```
...
## Focus styles
```html
<button class="rounded-md px-4 py-2 text-white bg-sky-600 hover:bg-sky-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2">
  Continue
</button>
```
